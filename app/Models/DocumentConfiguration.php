...
class DocumentConfiguration extends Moloquent{

  protected $collection = 'DocumentConfiguration';
  protected $guarded = [];
  ...
  {
    $currentWarehouse = Session::get('currentWarehouse');
    return $query->where('warehouse_id', '=', new \MongoId($currentWarehouse['_id']));
  }
