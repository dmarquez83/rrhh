 ...
 */
angular.module('app').directive('pageTitle', pageTitle).directive('sideNavigation', sideNavigation).directive('iboxTools', iboxTools).directive('minimalizaSidebar', minimalizaSidebar).directive('vectorMap', vectorMap).directive('morrisArea', morrisArea).directive('morrisBar', morrisBar).directive('morrisLine', morrisLine).directive('morrisDonut', morrisDonut).directive('sparkline', sparkline).directive('icheck', icheck).directive('ionRangeSlider', ionRangeSlider).directive('dropZone', dropZone).directive('fancyBox', fancyBox).directive('responsiveVideo', responsiveVideo);