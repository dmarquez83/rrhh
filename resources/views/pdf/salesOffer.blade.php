      ...
      <tr>
        ...
        <td align="left" valign="top">
          <div class="document-info">
            <div class="max-line">
              <span style="font-size: 17px;"><b>OFERTA DE VENTA </b>&nbsp;&nbsp;&nbsp;{{$document['number']}} </strong></span><br/>
      ...
      <tr>
        <td colspan="2" align="left" valign="top">
          <div class="customer-info">
            ...
            <span><strong>Fecha de Vencimiento: </strong>{{ date('d-m-Y', strtotime($document['expireDate'])) }}</span><br/>
          </div>
        </td>
      </tr>
      <tr>
